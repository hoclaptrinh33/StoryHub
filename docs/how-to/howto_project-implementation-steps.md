...
### Giai đoạn 1: Dựng khung kỹ thuật (1-2 ngày)
...
### Giai đoạn 2: Dữ liệu và schema cốt lõi (2-3 ngày)
...
### Giai đoạn 3: Triển khai API cốt lõi (3-5 ngày)
...
### Giai đoạn 4: Triển khai UI kiosk chính (3-4 ngày)
...
1. Xây dựng màn POS kiosk 3 cột đúng ưu tiên thao tác nhanh.
2. Tích hợp barcode listener toàn cục, không phụ thuộc focus input.
3. Cài buffer timeout để tách scanner và nhập tay.
4. Xây dựng màn Rental return inspection theo đúng state machine.
5. Đồng bộ loading, error, success theo frontend scenarios trong blueprint.
6. Chuẩn hóa keyboard shortcuts cho tác vụ thường dùng.
7. Hiển thị cảnh báo rõ ràng khi lock conflict hoặc dữ liệu hết hiệu lực.
