...
def seed_database(database_url: str | None = None) -> dict[str, int]:
    ...
    try:
        ...
        volume_rows = [
            (11, 1, 105, "9784088826001", 5, now_iso, now_iso, None),
            (12, 1, 106, "9784088826018", 2, now_iso, now_iso, None),
            (21, 2, 98, "9784098503213", 10, now_iso, now_iso, None),
            (22, 2, 99, "9784098503220", 0, now_iso, now_iso, None),
            (31, 3, 1, None, 1, now_iso, now_iso, None),
        ]
